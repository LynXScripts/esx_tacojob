...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'taco' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function OpenVaultMenu()
    ...
    local elements = {
      {label = "Meat (x1) - 60$", value = 'meat'},
      {label = "Tomato (x1) - 60$", value = 'tomato'},
      {label = "Onion (x1) - 60$", value = 'onion'}
    }
    ...
    ESX.UI.Menu.Open(
	  ...
	  local valor = 0
		...
		if data.current.value == "meat" then
			valor = 8
		end
		...
		if data.current.value == "onion" then
			valor = 20
		end

		TriggerServerEvent('esx_tacojob:shop', data.current.value, valor)
      end,
...
function OpenCozinharMenu()
	...
	local elements = {
      ...
      {label = "Chopped meat", value = 'cmeat'},
      {label = "Chopped Onions", value = 'conion'},
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_tacojob:craftingCoktails', data.current.value)
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'taco', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'taco_actions',
    {
      title    = "Billing",
      align    = 'top-left',
      elements = elements
  ...
  ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
    ...
    if amount == nil or amount < 0 then
      ...
      if closestPlayer == -1 or closestDistance > 3.0 then
        ...
        menu.close()
        TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_taco', _U('taco'), amount)
      end
    end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_tacojob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_tacojob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_tacojob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_tacojob:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_tacojob:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_tacojob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_tacojob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_tacojob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_tacojob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_tacojob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'taco_shop',
        {
            title    = _U('shop'),
            elements = elements
        },
        function(data, menu)
            TriggerServerEvent('esx_tacojob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_tacojob:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_tacojob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_tacojob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_tacojob:hasExitedMarker', LastZone)
            end
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'taco', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'taco')
            end
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'taco_actions') then
...
RegisterNetEvent('esx_taco:StartCookAnimation')
AddEventHandler('esx_taco:StartCookAnimation', function()
exports['progressBars']:startUI(20000, "Cooking")
...
RegisterNetEvent('esx_taco:StopCookAnimation')
AddEventHandler('esx_taco:StopCookAnimation', function()
local ped = GetPlayerPed(-1)
